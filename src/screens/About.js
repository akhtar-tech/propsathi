            ...
            <main id="content">
                ...
                <section style={{ backgroundImage: 'url("images/bg-about-us.jpg")' }} className="bg-img-cover-center py-10 pt-md-16 pb-md-17 bg-overlay">
                    <div className="container position-relative z-index-2 text-center">
                        <a href="https://www.youtube.com/watch?v=0O2aH4XLbto" className="d-inline-block m-auto position-relative play-animation" data-gtf-mfp="true" data-mfp-options="{&quot;type&quot;:&quot;iframe&quot;}">
                        ...
                        <div className="card border-0 mt-n13 z-index-3 mb-12">
                            <div className="card-body p-6 px-lg-14 py-lg-13">
                                <p className="letter-spacing-263 text-uppercase text-primary mb-6 font-weight-500 text-center">
                                    welcome to
                                    grandhome</p>
                                <h2 className="text-heading mb-4 fs-22 fs-md-32 text-center lh-16 px-6">We see change as
                                    opportunity, not a
                                    threat and
                                    start
                                    with the
                                ...
                                <p className="text-center px-lg-11 fs-15 lh-17 mb-11">
                                    Over the past 25 years we’ve created more than 5,000 new homes and 1.5 million sq ft of
                                    workspace in
                                    over 60 regeneration projects. Have a look at the short film below to learn more about how
                                    we’ve
                                ...
                                <div className="d-flex flex-wrap justify-content-center">
                                    ...
                                    <a href="#" className="btn btn-lg bg-gray-01 text-body mr-4 mb-4 hover-primary">Offices
                                        Location</a>
                            ...
                            <div className="col-md-4 mb-6 mb-lg-0">
                                <div className="card shadow-2 px-7 pb-6 pt-4 h-100 border-0">
                                    <div className="card-img-top d-flex align-items-end justify-content-center">
                                        <span className="text-primary fs-90 lh-1"><svg className="icon icon-e1">
                                ...
                                <div className="map-info position-absolute">
                                    <div className="card border-0 shadow-xs-4">
                                        <div className="card-body pl-7 pr-6 pt-7 pb-10">
                                            ...
                                            <p className="mb-8">Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe ndisse
                                                suscorem
                                                ipsum dolor sit
                ...
                <section className="pt-12">
                    <div className="container">
                        ...
                        <p className="text-center px-md-17 fs-15 lh-17 mb-8">
                            Our home is at the heart of the design, allowing us to engage with our community through talks and
                            events,
