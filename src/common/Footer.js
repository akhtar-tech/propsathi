                ...
                <div className="row">
                    <div className="col-md-6 col-lg-4 mb-6 mb-md-0">
                        ...
                        <div className="lh-26 font-weight-500">
                            ...
                            <a className="d-block text-lighter font-weight-bold fs-15 hover-white" href="tel:(+68)122109876">(+68)1221
                                09876</a>
                            <a className="d-block text-muted hover-white" href=".html">www.homeid.com</a>
                        </div>
                    </div>
